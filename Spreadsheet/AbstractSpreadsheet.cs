...
/// 
/// I, Nik McKnight, certify that I have written nothing in this class except for comments on the bottom three methods.
/// 
/// </summary>
...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        {
            // A list of cells that need to be recalculated
            LinkedList<String> changed = new LinkedList<String>();
            // A list of cells that have been checked
            ...
            // Return all cells that need to be changed
            return changed;
        }
        ...
        /// </summary>
        /// <param name="start">The starting cell from GetCellsToRecalculate.</param>
        /// <param name="name">The name of the current cell being checked.</param>
        /// <param name="visited">Cells that have been visited by this function already.</param>
        /// <param name="changed">Cells whose values need to be recalculated.</param>
        /// <exception cref="CircularException"></exception>
        private void Visit(String start, String name, ISet<String> visited, LinkedList<String> changed)
        {
            // Mark that the cell [name] has been visited
            visited.Add(name);
            // checks each dependent of [name]
            foreach (String n in GetDirectDependents(name))
            {
                ...
                // Visits the dependent if it has not been visited already
            ...
            // Adds [name] to the list of cells that need to be recalculated
